<x-app-layout>
    <div class="max-w-7xl mx-auto px-6 flex flex-col gap-12">
        ...
        <!-- SEARCH -->
        <form method="GET" action="{{ route('videos') }}" class="flex justify-center">
            <div class="relative w-full max-w-xl">
                ...
                <input
                    ...
                    class="w-full pl-5 pr-5 py-3 rounded-full
                    bg-white/10 backdrop-blur-md border border-white/20
                    text-white placeholder-white/60 outline-none focus:ring-2 focus:ring-white/30"
                >
                ...
                <div class="bg-white rounded-xl overflow-hidden shadow">
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-gray-600 text-sm mt-1">
                            Ceci est une description courte pour la carte {{ $i }}.
                        </p>
                    </div>
