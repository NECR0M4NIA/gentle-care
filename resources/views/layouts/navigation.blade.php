            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="/assets/icons/gentle-care-orange.svg" width="48" class="block dark:hidden fill-current transition hover:opacity-[0.85]" />
                        <img src="/assets/icons/gentle-care-blue.svg" width="48" class="hidden dark:block fill-current transition hover:opacity-[0.85]" />
                    </a>
                </div>
